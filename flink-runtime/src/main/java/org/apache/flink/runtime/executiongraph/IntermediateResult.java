...
/**
 * todo
 * 	  JobGraph ------> IntermediateDataSet 表示 JobVertex的对外输出
 * 	  一个JobGraph可能有(n>=0)个输出, 在EexectionGraph中与此对应的就是IntermediateResult
 *
 * todo
 * 	  由于ExecutionJobVertex有numParallelProducers个并行的子任务, 自然对应的每个IntermediateResult
 * 	  就有numParallelProducers个生产者, 每个生产者的在相应的IntermediateResult上的输出对应一个IntermediateResultPartition
 *
 * 	  IntermediateResultPartition 表示的是ExecutionVertex的一个输出分区
 */
public class IntermediateResult {
	// todo 对应的 IntermediateDataSet 的ID
