...
class PipelinedSubpartition extends ResultSubpartition {
	...
	// todo 当前subpartition 堆积的所有的Buffer的队列
	...
	// ------------------------------------------------------------------------
	// todo index 是当前sub-partition的索引
	...
	/**
	 * todo 添加一个新的bufferConsumer
	 * 		这个参数里的finish指的是整个subparition都完成了
	 */
	private boolean add(BufferConsumer bufferConsumer, boolean finish) {
		...
		synchronized (buffers) {
			...
			// todo 更新backLog的数量,只有Buffer才会使得BufferInBackLog+1 事件不会增加BuffersInBackLog
