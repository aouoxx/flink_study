...
public class TaskManagerServices {
	...
	public static TaskManagerServices fromConfiguration(
		...
		// todo 创建ShuffleEnvironment 对象, 默认是(NettyShuffleEnvironment)
		...
		// TODO  创建KvStateService 实例并启动
		final KvStateService kvStateService = KvStateService.fromConfiguration(taskManagerServicesConfiguration);
		kvStateService.start();

		// todo 初始化TaskManagerLocation 纪录connection信息
		...
		// todo 维护jobId 与 JobManager connection之间的关系
		final JobManagerTable jobManagerTable = new JobManagerTable();

		// todo 监控注册的job 的 JobManager leader信息
		...
		//todo: 创建 TaskExecutorLocalStateStoresManager 对象：维护状态信息
		final TaskExecutorLocalStateStoresManager taskStateManager = new TaskExecutorLocalStateStoresManager(
			taskManagerServicesConfiguration.isLocalRecoveryEnabled(),
			stateRootDirectoryFiles,
			taskIOExecutor);
		//todo: 将上面初始化的这些服务，封装到一个 TaskManagerServices 对象中
