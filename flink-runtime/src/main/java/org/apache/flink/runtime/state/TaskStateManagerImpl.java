...
public class TaskStateManagerImpl implements TaskStateManager {
	...
	public void reportTaskStateSnapshots(
		...
		// todo 发送ACK响应给CheckpointCoordinator, 发送快照成功的消息
		checkpointResponder.acknowledgeCheckpoint(  // todo 调用RpcCheckpointResponder类中的方法
			jobId,
			executionAttemptID,
			checkpointId,
			checkpointMetrics,
	...
	public PrioritizedOperatorSubtaskState prioritizedOperatorState(OperatorID operatorID) {
		...
		// todo 构建 PrioritizedOperatorSubtaskState
